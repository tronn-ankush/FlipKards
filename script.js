class AudioController {
    constructor() {
        this.pbSound = new Audio('SFX/The-Avengers-Theme-Song.wav');
        this.rollSound = new Audio('SFX/Flip-sound.wav');
        this.matchSound = new Audio('SFX/mixkit-ethereal-fairy-win-sound-2019.wav');
        this.victorySound = new Audio('SFX/mixkit-male-voice-cheer-victory-2011.wav');
        this.gameOverSound = new Audio('SFX/game over evil.wav');
        this.timeWarning =new Audio('SFX/mixkit-tick-tock-clock-close-up-1059.wav');
